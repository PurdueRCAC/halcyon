...
class Behavior
{
	...
	public static function framework($extras = false, $debug = null)
	{
		...
		$path = rtrim(app('request')->root(true), '/') . $path;
	...
	private static function _pushScriptTo($index, $url, $type = 'text/javascript', $defer = false, $async = false)
	{
		...
		if ($document instanceof \App\Halcyon\Document\Type\Html)
		{
			$pushed = false;
	...
	public static function core()
	{
		...
		//Asset::script('assets/halcyon.js', true, true);
