...
class Date extends DateTime
{
	...
	public function dayToString($day, $abbr = false)
	{
		...
		{
			case 0:
				return $abbr ? \trans('SUN') : \trans('SUNDAY');
			case 1:
				return $abbr ? \trans('MON') : \trans('MONDAY');
			case 2:
				return $abbr ? \trans('TUE') : \trans('TUESDAY');
			case 3:
				return $abbr ? \trans('WED') : \trans('WEDNESDAY');
			case 4:
				return $abbr ? \trans('THU') : \trans('THURSDAY');
			case 5:
				return $abbr ? \trans('FRI') : \trans('FRIDAY');
			case 6:
				return $abbr ? \trans('SAT') : \trans('SATURDAY');
		}
	}
	...
	public function monthToString($month, $abbr = false)
	{
		...
		{
			case 1:
				return $abbr ? \trans('JANUARY_SHORT') : \trans('JANUARY');
			case 2:
				return $abbr ? \trans('FEBRUARY_SHORT') : \trans('FEBRUARY');
			case 3:
				return $abbr ? \trans('MARCH_SHORT') : \trans('MARCH');
			case 4:
				return $abbr ? \trans('APRIL_SHORT') : \trans('APRIL');
			case 5:
				return $abbr ? \trans('MAY_SHORT') : \trans('MAY');
			case 6:
				return $abbr ? \trans('JUNE_SHORT') : \trans('JUNE');
			case 7:
				return $abbr ? \trans('JULY_SHORT') : \trans('JULY');
			case 8:
				return $abbr ? \trans('AUGUST_SHORT') : \trans('AUGUST');
			case 9:
				return $abbr ? \trans('SEPTEMBER_SHORT') : \trans('SEPTEMBER');
			case 10:
				return $abbr ? \trans('OCTOBER_SHORT') : \trans('OCTOBER');
			case 11:
				return $abbr ? \trans('NOVEMBER_SHORT') : \trans('NOVEMBER');
			case 12:
				return $abbr ? \trans('DECEMBER_SHORT') : \trans('DECEMBER');
		}
	}
	...
	public function relative($unit = null, $time = null)
	{
		...
		if ($diff < 60)
		{
			return \trans('JLIB_HTML_DATE_RELATIVE_LESSTHANAMINUTE');
		}
		...
		{
			return \transs('JLIB_HTML_DATE_RELATIVE_MINUTES', $diff);
		}
		...
		{
			return \transs('JLIB_HTML_DATE_RELATIVE_HOURS', $diff);
		}
		...
		if ($diff < 7 || $unit == 'day')
		{
			return \transs('JLIB_HTML_DATE_RELATIVE_DAYS', $diff);
		}
		...
		if ($diff <= 4 || $unit == 'week')
		{
			return \transs('JLIB_HTML_DATE_RELATIVE_WEEKS', $diff);
		}
