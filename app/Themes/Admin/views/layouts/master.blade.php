...
?>
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="no-js" data-mode="{{ $mode }}" data-bs-theme="{{ $mode }}" dir="{{trans('theme::admin.text_direction')}}">
			...
			<h1>
				<a href="{{ url()->to('/') }}">
					<span class="logo-container">
						...
						<img src="{{ asset($file) }}" alt="{{ config('app.name') }}" loading="lazy" />
						@else
