...
(function($){
            ...
            function () {
                ...
                if (!jQuery('#ptTimeSelectCntr').length) {
                    jQuery("body").append(
                        ...
                        +    '                    <div class="ptTimeSelectLeftPane" style="width: 120px; text-align: center; float: left;" class="">Hour</div>'
                        +    '                    <div class="ptTimeSelectRightPane" style="width: 156px; text-align: center; float: left;">Minutes</div>'
                        +    '                </div>'
                        +    '                <div>'
                        ...
                        +    '                            <div class="ptTimeSelectMinCntr" style = "padding-left: 3px;">'
                        ...
                        +    '                                <br style="clear: left;" />'
                        +    '                                <a class="ptTimeSelectTm ui-state-default" href="javascript: void(0);" style = "width:5.0em">AM</a>'
                        +    '                                <a class="ptTimeSelectTm ui-state-default" href="javascript: void(0);" style = "width:5.0em">PM</a>'
                        +    '                                <br style="clear: left;" /><div></div>'
                        +    '                            </div>'
                        +    '                        </div>'
                        +    '                    </div>'
			     ...
			     mouseleave: function(){
			      $(this).toggleClass("ui-state-hover");
                    ...
                    e.find('.ptTimeSelectTm')
                        .bind({click: function(){
	                       jQuery.ptTimeSelect.setTm($(this).text());
	                 },
			     mouseenter: function(){
			      $(this).toggleClass("ui-state-hover");
			 },
     ...
     * 
     * @private 
     * @param  {Integer}   h   -   Integer indicating the hour. This value
     *                      is the same as the text value displayed on the
     *                      popup under the hour. 
     * @return {undefined}
     * 
     */
    jQuery.ptTimeSelect.setHr = function(h) {
	var buttons = jQuery('#ptTimeSelectCntr').find('.ptTimeSelectHr');
        jQuery('#ptTimeSelectUserSelHr').empty().append(h);
	for (var x=0; x<buttons.length; x++) {
		if (buttons[x].innerHTML == h) {
			buttons[x].className = 'ptTimeSelectHr ui-state-active';
		} else {
			buttons[x].className = 'ptTimeSelectHr ui-state-default';
		}
	}
    ...
    /**
     * Sets the AM PM selected by the user on the popup.
     * 
     * @private 
     * @param  {Integer}   tm   -   This value is the  words AM or PM.
     * @return {undefined}
     * 
     */
    jQuery.ptTimeSelect.setTm = function(tm) {
	var buttons = jQuery('#ptTimeSelectCntr').find('.ptTimeSelectTm');
        jQuery('#ptTimeSelectUserSelAmPm').empty().append(tm);
	for (var x=0; x<buttons.length; x++) {
		if (buttons[x].innerHTML == tm) {
			buttons[x].className = 'ptTimeSelectTm ui-state-active';
		} else {
			buttons[x].className = 'ptTimeSelectTm ui-state-default';
		}
        }
	jQuery.ptTimeSelect.setTime();
    };// END setTm() function
     ...
     * 
     * @private
     * @param {Integer}    m   - integer indicating the minutes. This
	...
	var buttons = jQuery('#ptTimeSelectCntr').find('.ptTimeSelectMin');
	for (var x=0; x<buttons.length; x++) {
		if (buttons[x].innerHTML == m) {
			buttons[x].className = 'ptTimeSelectMin ui-state-active';
		} else {
			buttons[x].className = 'ptTimeSelectMin ui-state-default';
		}
	}
	jQuery.ptTimeSelect.setTime();
    };// END setMin() function
	...
	var buttons = cntr.find('.ptTimeSelectTm');	
	for (var x=0; x<buttons.length; x++) {
		if (buttons[x].innerHTML == tm) {
			buttons[x].className = 'ptTimeSelectTm ui-state-active';
		} else {
	...
	var buttons = cntr.find('.ptTimeSelectHr');	
	for (var x=0; x<buttons.length; x++) {
		if (buttons[x].innerHTML == hr) {
			buttons[x].className = 'ptTimeSelectHr ui-state-active';
		} else {
			buttons[x].className = 'ptTimeSelectHr ui-state-default';
		}
	}
	buttons = cntr.find('.ptTimeSelectMin');	
	for (var x=0; x<buttons.length; x++) {
		if (buttons[x].innerHTML == min) {
			buttons[x].className = 'ptTimeSelectMin ui-state-active';
		} else {
			buttons[x].className = 'ptTimeSelectMin ui-state-default';
		}
