        ...
        */
        ...
        var start = function(){
          ...
          for(; start_date.getTime() <= end_date.getTime(); start_date.setDate(start_date.getDate() + 1)) {
              ...
              item_html += '<rect class="day ' + color + '" width="11" height="11" y="' + y + '" data-count="' + count + '" data-date="' + data_date + '" rx="' + radius + '" ry="' + radius + '"/>';  
        ...
        var settings = $.extend({
          colors: ['color1', 'color2', 'color3', 'color4', 'color5'], //['#eeeeee', '#d6e685', '#8cc665', '#44a340', '#44a340']
          border:{
            radius: 2,
            hover_color: "#999"
          },
