...
<form action="{{ route('admin.finder.fields') }}" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<table class="table table-hover adminlist">
		<caption class="sr-only">{{ trans('finder::finder.fields') }}</caption>
		<thead>
			<tr>
