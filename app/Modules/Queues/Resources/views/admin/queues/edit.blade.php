									...
									<form class="modal-content dialog-content shadow-sm" method="post" action="{{ route('admin.queues.store') }}" data-api="{{ route('api.queues.' . ($item->type == 1 ? 'loans' : 'sizes') . '.update', ['id' => $item->id]) }}">
										...
										<div class="modal-body dialog-body">
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label for="loan-cores{{ $item->id }}">{{ trans('queues::queues.cores') }} <span class="text-muted">({{ trans('queues::queues.cores per ' . $unit, ['cores' => $row->subresource->nodecores]) }})</span></label>
				...
				<form class="modal-content dialog-content shadow-sm" method="post" action="{{ route('admin.queues.store') }}" data-api="{{ route('api.queues.sizes.create') }}">
					...
					<div class="modal-body dialog-body">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="sell-cores">{{ trans('queues::queues.cores') }} <span class="text-muted">({{ trans('queues::queues.cores per ' . $unit, ['cores' => $row->subresource->nodecores]) }})</span></label>
				...
				<form class="modal-content dialog-content shadow-sm" method="post" action="{{ route('admin.queues.store') }}" data-api="{{ route('api.queues.loans.create') }}">
					...
					<div class="modal-body dialog-body">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="loan-cores">{{ trans('queues::queues.cores') }} <span class="text-muted">({{ trans('queues::queues.cores per ' . $unit, ['cores' => $row->subresource->nodecores]) }})</span></label>
