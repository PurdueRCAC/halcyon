			...
			foreach ($queues as $q)
			{
				...
				@endif
					...
					<td class="text-right">
						...
						<a class="btn tip" data-toggle="collapse" data-parent="#queues" href="#collapse{{ $q->id }}" title="Purchases &amp; Loans">
							<span class="fa fa-list"></span><span class="sr-only">Purchases &amp; Loans</span>
						</a>
						@endif
						@if (auth()->user()->can('delete queues'))
