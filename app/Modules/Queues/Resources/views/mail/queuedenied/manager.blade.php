...
Requests for access to your {{ config('app.name') }} resources has been **<span style="color:red;">denied</span>** for the following people, resources and queues that you manage.
