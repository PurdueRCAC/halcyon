...
return [
	...
	'queue is interactive' => 'Queue is interactive.',
	'queue has no active resources' => 'Queue has no active resources. Remove queue or sell/loan nodes or service units.',
	...
	'end' => 'End',
	'free' => 'Interactive',
	'free desc' => 'Does not require allocations.',
	'shared' => 'Shared',
	...
	'flag denyonlimit desc' => 'If set, jobs using this QOS will be rejected at submission time if they do not conform to the QOS \'Max\' limits as stand-alone jobs.',
	'flag enforceusagethreshold desc' => 'If set, and the QOS also has a UsageThreshold, any jobs submitted with this QOS that fall below the UsageThreshold will be held until their Fairshare Usage goes above the Threshold.',
	'flag noreserve desc' => ' If this flag is set and backfill scheduling is used, jobs using this QOS will not reserve resources in the backfill schedule\'s map of resources allocated through time.',
	'flag partitionmaxnodes desc' => 'If set, jobs using this QOS will be able to override the requested partition\'s MaxNodes limit.',
	'flag partitionminnodes desc' => 'If set, jobs using this QOS will be able to override the requested partition\'s MinNodes limit.',
	'flag overpartqos desc' => 'If set, jobs using this QOS will be able to override any limits used by the requested partition\'s QOS limits.',
	'flag partitiontimelimit desc' => 'If set, jobs using this QOS will be able to override the requested partition\'s TimeLimit.',
	'flag requiresreservation desc' => 'If set, jobs using this QOS must designate a reservation when submitting a job.',
