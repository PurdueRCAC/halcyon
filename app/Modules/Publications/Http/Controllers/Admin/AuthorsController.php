...
use App\Modules\Publications\Models\Item;
...
class ItemsController extends Controller
{
	...
	public function create(Request $request)
	{
		...
		$widgets = \App\Modules\Publications\Models\Widget::forMenuId($row->id ? $row->id : 0);
	...
	public function edit($id)
	{
		...
		$widgets = \App\Modules\Publications\Models\Widget::forMenuId($row->id);
