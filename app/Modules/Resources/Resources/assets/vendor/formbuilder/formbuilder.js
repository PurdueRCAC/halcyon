...
(function() {
  Formbuilder.registerField('calendar', {
    order: 20,
    view: "<input type='text' class='form-control calendar rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' placeholder='YYYY-MM-DD HH:mm:ss' />",
    edit: '',
    addButton: '<span class="symbol"><span class="fa fa-calendar" aria-hidden="true"></span></span> Date/Time'
  });
}).call(this);
...
(function() {
  Formbuilder.registerField('dropdown', {
    ...
    addButton: "<span class=\"symbol\"><span class=\"fa fa-chevron-down\" aria-hidden=\"true\"></span></span> Dropdown",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "",
...
(function() {
  Formbuilder.registerField('number', {
    order: 30,
    view: "<input type='number' class='form-control' />\n<% if (units = rf.get(Formbuilder.options.mappings.UNITS)) { %>\n  <%= units %>\n<% } %>",
    edit: "<%= Formbuilder.templates['edit/min_max']() %>", //\n<%= Formbuilder.templates['edit/units']() %>\n<%= Formbuilder.templates['edit/integer_only']() %>",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-number\" aria-hidden=\"true\">123</span></span> Number"
  });
}).call(this);
...
(function() {
  Formbuilder.registerField('radio', {
    ...
    edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
    addButton: "<span class=\"symbol\"><span class=\"fa fa-dot-circle-o\" aria-hidden=\"true\"></span></span> Multiple Choice",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "",
...
(function() {
  Formbuilder.registerField('text', {
    ...
    edit: '', //"<%= Formbuilder.templates['edit/size']() %>\n<%= Formbuilder.templates['edit/min_max_length']() %>",
    addButton: "<span class='symbol'><span class='fa fa-align-left' aria-hidden='true'></span></span> Text",
    defaultAttributes: function(attrs) {
      attrs.field_options.size = 'small';
      return attrs;
    }
...
(function() {
  Formbuilder.registerField('url', {
    order: 35,
    view: '<input type="text" class="form-control" placeholder="http://" />',
    edit: '',
...
this["Formbuilder"]["templates"]["edit/checkboxes"] = function(obj) {
  ...
  with (obj) {
    ...
    __p += '</select>\n  </label>\n*/
    __p += '<div class="row"><div class="col col-md-4"><label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
    ((__t = ( Formbuilder.options.mappings.REQUIRED )) == null ? '' : __t) +
    '\' />\n  Required\n</label>\n</div><div class="col col-md-4"><label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
...
this["Formbuilder"]["templates"]["edit/label_description"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class="form-group"><input type="text" class="form-control" data-rv-input="model.' + ((__t = (Formbuilder.options.mappings.LABEL)) == null ? '' : __t) + '" /></div>\n' +
      '<div class="form-group"><input type="text" class="form-control" data-rv-input="model.' + ((__t = (Formbuilder.options.mappings.NAME)) == null ? '' : __t) + '" placeholder="Add a name for this field" /></div>\n' +
      '<div class="form-group"><textarea class="form-control" data-rv-input=\'model.' + ((__t = (Formbuilder.options.mappings.DESCRIPTION)) == null ? '' : __t) + '\' placeholder=\'Add a longer description to this field\'></textarea></div>\n' +
      '<div class="form-group"><input type=\'text\' class="form-control" data-rv-input=\'model.' + ((__t = (Formbuilder.options.mappings.VALUE)) == null ? '' : __t) + '\' placeholder=\'Enter default value\' /></div>\n' +
    '<div class="form-group"><input type=\'text\' class="form-control" data-rv-input=\'model.' + ((__t = ( Formbuilder.options.mappings.PLACEHOLDER )) == null ? '' : __t) + '\' placeholder=\'Enter default placeholder\' /></div>';
  }
  return __p
};
...
this["Formbuilder"]["templates"]["edit/options"] = function(obj) {
  ...
  with (obj) {
    ...
    __p += '\n\n<div class=\'option form-group\' data-rv-each-option=\'model.' + ((__t = ( Formbuilder.options.mappings.OPTIONS )) == null ? '' : __t) + '\'>\n' +
      '<input type="checkbox" class=\'js-default-updated\' data-rv-checked="option:checked" />\n' +
      '<input type="text" data-rv-input="option:label" class=\'form-control option-label-input\' placeholder="Label" />\n' +
      '<input type="text" data-rv-input="option:value" class=\'form-control option-value-input\' placeholder="Value (if different than label)" />\n' +
      '<a class="btn-danger js-remove-option ' + ((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) + '" title="Remove Option"><span class=\'fa fa-trash\' aria-hidden="true"></span></a>\n' +
      '</div>\n\n';
    ...
    __p += '\n\n<div class=\'fb-bottom-add\'>\n  <a class="btn-success js-add-option ' +
...
this["Formbuilder"]["templates"]["view/duplicate_remove"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class=\'actions-wrapper\'>\n  <a class="btn-success js-duplicate ' +
      ((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
      '" title="Duplicate Field"><span class=\'fa fa-plus-circle\' aria-hidden="true"></span></a>\n  <a class="btn-danger js-clear ' +
      ((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
      '" title="Remove Field"><span class=\'fa fa-trash\' aria-hidden="true"></span></a>\n</div>';
  }
  return __p
};
