...
<form action="{{ route('admin.resources.types') }}" method="get" name="adminForm" id="adminForm" class="form-inline">
	...
	<table class="table table-hover adminlist">
		<caption class="sr-only visually-hidden">{{ trans('resources::resources.types') }}</caption>
		<thead>
			<tr>
				@if (auth()->user()->can('delete resources.types'))
					<th>
