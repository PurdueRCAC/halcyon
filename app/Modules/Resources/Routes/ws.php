...
// Types
$router->group(['prefix' => 'resourcetype'], function (Router $router)
{
	$router->get('/', [
...
// Members
$router->group(['prefix' => 'resourcemember'], function (Router $router)
{
	$router->get('/', [
...
// Subresource
$router->group(['prefix' => 'subresource'], function (Router $router)
{
	$router->get('/', [
...
// Batchsystems
$router->group(['prefix' => 'batchsystem'], function (Router $router)
{
	$router->get('/', [
