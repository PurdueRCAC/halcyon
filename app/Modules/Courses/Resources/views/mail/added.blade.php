...
Any students who add or drop the course will be automatically added or removed from {{ $class->role }} within 1 to 2 business days of notifying the registrar.
...
{{ route('page', ['uri' => 'policies/scholar']) }}
