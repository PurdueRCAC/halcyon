...
<link rel="stylesheet" type="text/css" media="all" href="{{ timestamped_asset('modules/issues/css/site.css') }}" />
@endpush
...
<script src="{{ timestamped_asset('modules/issues/js/site.js')) }}"></script>
@endpush
