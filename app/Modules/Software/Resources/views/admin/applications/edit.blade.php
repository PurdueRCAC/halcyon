...
@section('toolbar')
	@if (auth()->user()->can('edit software'))
		{!! Toolbar::save(route('admin.software.store')) !!}
	@endif
	{!! Toolbar::cancel(route('admin.software.cancel')) !!}
	{!! Toolbar::render() !!}
@stop

@section('title')
{{ trans('software::software.module name') }}: {{ $row->id ? trans('global.edit') . ': #' . $row->id : trans('global.create') }}
@stop

@section('content')
<form action="{{ route('admin.software.store') }}" method="post" name="adminForm" id="item-form" class="editform form-validate" enctype="multipart/form-data">
		...
		<div class="col col-md-8">
			<fieldset class="adminform">
				...
				<div class="form-group">
					...
					{!! editor('content', $row->content, ['id' => 'field-content', 'rows' => 50, 'class' => ($errors->has('content') ? 'is-invalid' : '')]) !!}
