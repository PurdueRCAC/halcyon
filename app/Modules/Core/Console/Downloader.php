...
class Downloader
{
	 ...
	 */
	public function download(string $package): void
	{
		...
		{
			$this->output->writeln("<error>The folder [App/Modules/{$this->extractPackageNameFrom($package)}] already exists.</error>");
			return;
		}
		...
		$this->output->writeln("<comment>Module downloaded in the App/Modules/{$this->extractPackageNameFrom($package)} directory!</comment>");
	}
	 ...
	 * @return $this
	 */
	protected function downloadFile(string $zipFile, string $latestVersionUrl)
	{
	 ...
	 * @throws \Exception
	 */
	private function getLatestVersionUrl(): string
	{
	 ...
	 * @throws \Exception
	 */
	private function extractPackageNameFrom(string $package): string
	{
	 ...
	 * @return $this
	 */
	public function forBranch(string $branchName)
	{
