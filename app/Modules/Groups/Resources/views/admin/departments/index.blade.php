...
@section('title')
{{ trans('groups::groups.module name') }}: {{ trans('groups::groups.departments') }}
@stop
...
<form action="{{ route('admin.groups.departments') }}" method="get" name="adminForm" id="adminForm" class="form-inline">
	...
	<table class="table table-hover adminlist">
		<caption class="sr-only visually-hidden">{{ trans('groups::groups.departments') }}</caption>
		<thead>
			<tr>
