		...
		<div class="card-body">
			...
			@endif
					...
					<div class="input-group">
						...
						<!-- 
						<input type="text" name="u" id="newuser" class="form-control searchuser" placeholder="Search for user..." data-noaccount="No local account" data-api="{{ route('api.users.index') }}" data-url="{{ request()->url() }}"<?php if ($user->id != auth()->user()->id) { echo ' value="' . $user->name . ' (' . $user->username . ')"'; } ?> />
						 -->
