								...
								<form method="post" class="modal-content dialog-content shadow-sm">
									...
									<div class="modal-body dialog-body">
										...
										if (count($child_dirs) > 0 && $dir->parentstoragedirid) { ?>
											<div class="row mb-3">
												<div class="col-md-4">
													Read access for <?php echo $bottle_dirs_string; ?>
												</div>
												<div class="col-md-8">
													...
													<?php if ($dir->unixPermissions->other->read) { ?>
														...
														<label for="<?php echo $dir->id; ?>_other_read_box" class="form-check-label"><span id="<?php echo $dir->id; ?>_other_read_span" class="hide">{{ trans('global.yes') }}</span> to directories:</label>
													<?php } else { ?>
														<input type="checkbox" id="<?php echo $dir->id; ?>_other_read_box" class="form-check-input" />
														<label for="<?php echo $dir->id; ?>_other_read_box" class="form-check-label"><span id="<?php echo $dir->id; ?>_other_read_span" class="hide">{{ trans('global.no') }}</span> to directories:</label>
													<?php } ?>
													</span>
